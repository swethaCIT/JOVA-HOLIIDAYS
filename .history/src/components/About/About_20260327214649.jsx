  ...
  const slides = [
    {
      ...
      cardText: "Travel should feel simple and enjoyable.",
      features: ["Comfort", "Safety"],
    },
    {
      introTitle: "Designed Around Your Budget",
      introText: `Every journey we create is designed around your needs and your budget.`,
      cardTitle: "Plan Around Your Budget",
      cardText: "Best value without compromise.",
      features: ["Savings", "Best Value"],
    },
    {
      introTitle: "Reliable Support In Every Step",
      introText: `We stay connected throughout your journey.`,
      cardTitle: "Connected With Care Always",
      cardText: "Trusted by thousands of travelers.",
